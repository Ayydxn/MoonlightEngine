...
*/
    ...
    #define ENGINE_ASSERT_INTERNAL()                           FLogging::LogAssertMessage(ELogType::Engine, "Assertion Failed", "")
    #define APPLICATION_ASSERT_INTERNAL()                      FLogging::LogAssertMessage(ELogType::Application, "Assertion Failed", "")

    #define ENGINE_ASSERT_MESSAGE_INTERNAL(Message, ...)       FLogging::LogAssertMessage(ELogType::Engine, "Assertion Failed", Message, ##__VA_ARGS__)
    #define APPLICATION_ASSERT_MESSAGE_INTERNAL(Message, ...)  FLogging::LogAssertMessage(ELogType::Application, "Assertion Failed", Message, ##__VA_ARGS__)
    ...
    #define ENGINE_VERIFY_INTERNAL()               FLogging::LogAssertMessage(ELogType::Engine, "Verify Failed", "")
    #define APPLICATION_VERIFY_INTERNAL()          FLogging::LogAssertMessage(ELogType::Application, "Verify Failed", "")

    #define ENGINE_VERIFY_MESSAGE_INTERNAL(Message, ...)       FLogging::LogAssertMessage(ELogType::Engine, "Verify Failed", Message, ##__VA_ARGS__)
    #define APPLICATION_VERIFY_MESSAGE_INTERNAL(Message, ...)  FLogging::LogAssertMessage(ELogType::Application, "Verify Failed", Message, ##__VA_ARGS__)
