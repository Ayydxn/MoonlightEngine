...
{
public:
    FWindowMinimizeEvent(bool bIsWindowMinimized)
...
{
public:
    FWindowResizeEvent(uint32 NewWindowWidth, uint32 NewWindowHeight)
...
{
public:
    FWindowMovedEvent(int32 NewXPosition, int32 NewYPosition)
