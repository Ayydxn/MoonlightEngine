...
std::shared_ptr<FVertexBuffer> FVertexBuffer::Create(const void* BufferData, uint64 BufferSize)
{
    switch (FRenderer::GetGraphicsAPI())
    {
        case EGraphicsAPI::OpenGL: return std::make_shared<FOpenGLVertexBuffer>(BufferData, BufferSize);
